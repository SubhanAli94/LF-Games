  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground">
      ...
      <main className="flex-grow container mx-auto px-4 pb-8 pt-5">
        <p className="md:text-3xl text-2xl mx-auto w-full text-center pb-2 font-medium gradient-text">A collection of low-fidelity 2D web games</p>
        <p className='text-center font-normal text-sm md:text-lg sm:text-sm md:pb-6 sm:pb-3 text-gray-700'> Best experience on desktop-based browsers</p>
        <GamesGrid />
      </main>
